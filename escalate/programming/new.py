...
#or back to hex:
#print (hex(sum))
#https://stackoverflow.com/questions/45640652/adding-subtracting-hexadecimals


p.sendline(bytes(int(product, 16)))
# taking the hex conversion out worked 
#not working?, cant just convert to a string an send
